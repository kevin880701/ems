...
import 'package:ems_app/utils/widgets/chart/chart/VerticalBarChart.dart';
import 'package:ems_app/utils/widgets/chart/info/SymmetricBarChartInfo.dart';
import 'package:ems_app/utils/widgets/chart/info/TrendLineChartInfo.dart';
import 'package:ems_app/utils/widgets/chart/info/VerticalBarChartInfo.dart';
...
class VerticalBarWidget extends StatefulWidget {
  final String title;
  final String devid;
  ...
  @override
  _VerticalBarWidget createState() => _VerticalBarWidget();
}

class _VerticalBarWidget extends BasePageState<VerticalBarWidget> with SingleTickerProviderStateMixin {
