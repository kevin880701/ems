...
class TrendLineWidget extends StatefulWidget {
  ...
  @override
  _TrendLineWidget createState() => _TrendLineWidget();
}

class _TrendLineWidget extends BasePageState<TrendLineWidget> with SingleTickerProviderStateMixin {
